...
public:
	// 세팅 관련
	void AddChainData(EChainType PreChainType, EChainType ChainType, EAxisInputType AxisType, EButtonInputType ButtonType, float RequireStamina, FString CharacterName, FString SkillName, int32 ChainStep);
